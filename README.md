...
|---|---|---|---|
| 1 | Every search hit carries source_kind (+ staleness when decidable) and the CLI renders the caveat | — | [`fbc5d34`](https://github.com/techempower-org/mempalace/commit/fbc5d34) |
