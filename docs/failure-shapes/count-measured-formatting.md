---
slug: count-measured-formatting
shape: an instrument returning a true answer to a narrower question than the one asked
asked: did the code change?
instrument: a count
answered: how many lines differ in formatting?
control_passed: true
...
# count-measured-formatting

**Asked:** did the code change?

**Instrument:** `a count`

**Actually answered:** how many lines differ in formatting?
